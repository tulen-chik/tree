    ...
    useEffect(() => {
        if (id) {
            dispatch(setSelectedFamily({
                id,
                name: 'Loading...',
                description: '', // Provide a default or placeholder description
                created_at: new Date().toISOString(), // Use the current date as a placeholder
                plan_id: 0 // Provide a default or placeholder plan ID
            }));
